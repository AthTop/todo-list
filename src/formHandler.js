...
export function showEditProjectForm(project) {
    const projectInputs = [
        { label: 'Name', type: 'text', value: project.getName(), required: true, name: 'name' }
    ];
...
export function showEditTodoForm(todo) {
    const todoInputs = [
        { label: 'Title', type: 'text', value: todo.getTitle(), required: true, name: 'title' },
        { label: 'Description', type: 'text', value: todo.getDescription(), required: true, name: 'description' },
        { label: 'Due Date', type: 'date', required: true, name: 'duedate' , value: todo.getDueDate()},
        { label: 'Priority', type: 'select', required: true , name: 'priority', options: ['Low', 'Medium', 'High'], value: todo.getPriority()},
